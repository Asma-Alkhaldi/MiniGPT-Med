...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        with gr.Column(scale=1):
            ...
            # Add Audio Input for speech-to-text
            audio_input = gr.Audio(sources=["microphone"], type="filepath", label="Speak to Input Text Prompt")
        ...
        with gr.Column():
            ...
            # Define the text input box once
    ...
    # Link the audio input change to the text box
    audio_input.change(
        fn=speech_to_text,
        inputs=audio_input,
        outputs=text_input
